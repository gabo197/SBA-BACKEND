    ...
    public class ReportsController : ControllerBase
    {
        ...
        public async Task<IEnumerable<ReportResource>> GetAllAsync()
        {
            ...
            var resources = _mapper
                .Map<IEnumerable<Report.Domain.AgreggatesModel.Report>, IEnumerable<ReportResource>>(reports);
            return resources;
        }
        ...
        public async Task<IActionResult> PostAsync(int customerId, int technicianId, [FromBody] SaveReportResource resource)
        {
            ...
            var report = _mapper.Map<SaveReportResource, Report.Domain.AgreggatesModel.Report>(resource);
            var result = await _reportService.SaveAsync(customerId, technicianId, report);

            if (!result.Success)
                return BadRequest(result.Message);
            var reportResource = _mapper.Map<Report.Domain.AgreggatesModel.Report, ReportResource>(result.Resource);
