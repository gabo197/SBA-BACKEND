...
namespace SBA_BACKEND.Domain.Persistence.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<Customer.Customer.Domain.AgreggatesModel.Customer> Customers { get; set; }
        public DbSet<Address> Address { get; set; }
        public DbSet<Opinion> Opinions { get; set; }
        public DbSet<Report.Report.Domain.AgreggatesModel.Report> Reports { get; set; }
        public DbSet<Specialty> Specialties{ get; set; }
        public DbSet<TechnicianSpecialty> TechnicianSpecialties { get; set; }
        public DbSet<Technician.Technician.Domain.AgreggatesModel.Technician> Technicians { get; set; }
        public DbSet<User.User.Domain.AgreggatesModel.User> Users { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Report.Report.Domain.AgreggatesModel.Report>().ToTable("Reports");
            ...
            builder.Entity<User.User.Domain.AgreggatesModel.User>().ToTable("Users");
            ...
            //Constraints of User
            builder.Entity<User.User.Domain.AgreggatesModel.User>().HasKey(user => user.Id); //Primary Key
            builder.Entity<User.User.Domain.AgreggatesModel.User>().Property(user => user.Id).IsRequired().ValueGeneratedOnAdd(); //Auto Generate a Primary Key
            builder.Entity<User.User.Domain.AgreggatesModel.User>().Property(user => user.Email).IsRequired().HasMaxLength(50);
            builder.Entity<User.User.Domain.AgreggatesModel.User>().Property(user => user.Password).IsRequired().HasMaxLength(150);
            builder.Entity<User.User.Domain.AgreggatesModel.User>().Property(user => user.UserType).IsRequired().HasMaxLength(11);

            //Constraints of Profile
            builder.Entity<Profile>().HasKey(p => p.UserId);
            builder.Entity<Profile>().HasDiscriminator<string>("user_type")
                .HasValue<Customer.Customer.Domain.AgreggatesModel.Customer>("customer")
                .HasValue<Technician.Technician.Domain.AgreggatesModel.Technician>("technician");
            ...
            builder.Entity<Report.Report.Domain.AgreggatesModel.Report>().HasKey(report => report.Id); //Primary Key
            builder.Entity<Report.Report.Domain.AgreggatesModel.Report>().Property(report => report.Id).IsRequired().ValueGeneratedOnAdd(); //Auto Generate a Primary Key
            builder.Entity<Report.Report.Domain.AgreggatesModel.Report>().Property(report => report.Description).IsRequired().HasMaxLength(300);
            ...
            builder.Entity<User.User.Domain.AgreggatesModel.User>() //One to One with Profile
              .HasOne(user => user.Profile)
              .WithOne(profile => profile.User)
              .HasForeignKey<Profile>(profile => profile.UserId);

            builder.Entity<User.User.Domain.AgreggatesModel.User>() //One to One with Address
            ...
            builder.Entity<Report.Report.Domain.AgreggatesModel.Report>() //One to Many with Customer
                .HasOne(report => report.Customer)
                .WithMany(customer => customer.Reports)
                .HasForeignKey(report => report.CustomerId);

            builder.Entity<Report.Report.Domain.AgreggatesModel.Report>() //One to Many with Technician
            ...
            builder.Entity<User.User.Domain.AgreggatesModel.User>().HasData
                (
                    new User.User.Domain.AgreggatesModel.User
                    {
                        Id = 100,
            ...
            builder.Entity<Customer.Customer.Domain.AgreggatesModel.Customer>().HasData
                (
                    new Customer.Customer.Domain.AgreggatesModel.Customer
                    {
                        UserId = 100,
                        FirstName = "Pedro",
                        LastName = "Mustafa",
            ...
            builder.Entity<Report.Report.Domain.AgreggatesModel.Report>().HasData
                (
                    new Report.Report.Domain.AgreggatesModel.Report
                    {
                        Id = 100,
                        CustomerId = 103,
                        TechnicianId = 105,
            ...
            builder.Entity<Technician.Technician.Domain.AgreggatesModel.Technician>().HasData
                (
                    new Technician.Technician.Domain.AgreggatesModel.Technician
                    {
                        UserId = 104,
                        FirstName = "Xabier",
                        LastName = "Díaz",
