    ...
    stages {
        ...
        /*stage('Deploy'){
             steps{
               ...
               bat 'cd SBA-BACKEND/bin/Release/net5.0/publish/'
               bat 'nohup dotnet SBA-BACKEND.dll --urls="http://104.128.91.189:9090" --ip="104.128.91.189" --port=9090 --no-restore > /dev/null 2>&1 &'
             }
        }*/
    }
}